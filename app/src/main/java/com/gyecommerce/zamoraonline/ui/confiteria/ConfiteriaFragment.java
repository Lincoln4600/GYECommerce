package com.gyecommerce.zamoraonline.ui.confiteria;
...
public class ConfiteriaFragment extends Fragment {
    ...
    private boolean dist_dulces;


    public void onCreate (Bundle savedInstanceState){
        super.onCreate(savedInstanceState);

        //progressDialog = ProgressDialog.show(getActivity(), "Cargando productos",
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_confiteria, container, false);
    ...
    public void onStart () {
        ...
        tl_output = root.findViewById(R.id.tl_confiteria);
            ...
            target = new Target() {
                ...
                public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    if (PreloadImage) {
                        ...
                        if (NummaxPro[k] > 0 && (arr_CatProd[k].equals("DULCES") || arr_CatProd[k].equals("CHOCOLATES"))) {
                            FillTableLayout(k);
