package com.gyecommerce.zamoraonline.ui.suplementos;
...
public class SuplementosFragment extends Fragment {
    ...
    private boolean dis_suplementos;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_suplementos, container, false);
    ...
    public void onActivityCreated  (Bundle savedInstanceState) {
        ...
        tl_output = root.findViewById(R.id.tl_suplementos);
            ...
            target = new Target() {
                ...
                public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    if (PreloadImage) {
                        ...
                        if (NummaxPro[k] > 0 && (arr_CatProd[k].equals("SUPLEMENTOS")))
                        {
                            FillTableLayout(k);
                            row.addView(arr_second_layout[k]);
                            arr_imgVw[k].setImageBitmap(bitmap);
                            if (j == (NumProduct - 1)) {
                                mProgressBar.setVisibility(View.INVISIBLE);
                            }
    ...
    public void FillTagtName (){
        ...
        for (int i = 0; i <numart; i++)
        {
            TagLayout2Name = "ly_ID_Supl_"+ String.valueOf(i);
            TagTextName = "Tv_ID_Supl_" + String.valueOf(i);
