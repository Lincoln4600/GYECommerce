package com.gyecommerce.zamoraonline.ui.lacteos;
...
public class LacteosFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_lacteos, container, false);
    ...
    public void onActivityCreated  (Bundle savedInstanceState) {
        ...
        tl_output = root.findViewById(R.id.tl_lacteos);
            ...
            target = new Target() {
                ...
                public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    if (PreloadImage) {
                        ...
                        if (NummaxPro[k] > 0 && arr_CatProd[k].equals("LACTEOS"))
                        {
                            FillTableLayout(k);
