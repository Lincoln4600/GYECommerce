package com.gyecommerce.zamoraonline.ui.otros;
...
import com.gyecommerce.zamoraonline.Estadopedido;
...
public class OtrosFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_otros, container, false);
    ...
    public void onActivityCreated  (Bundle savedInstanceState) {
        ...
        tl_output = root.findViewById(R.id.tl_otros);
            ...
            target = new Target() {
                ...
                public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    if (PreloadImage) {
                        ...
                        if (arr_costProd[k] > 0 && arr_CatProd[k].equals("OTROS"))
                        {
                            FillTableLayout(k);
                ...
                public void onPrepareLoad(Drawable placeHolderDrawable) {
                    PreloadImage = true;
                    if (NummaxPro[k] > 0 && arr_CatProd[k].equals("OTROS"))
                    {
                        FillTableLayout(k);
                        row.addView(second_layout);
                    }
