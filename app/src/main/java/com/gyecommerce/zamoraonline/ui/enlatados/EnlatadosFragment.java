package com.gyecommerce.zamoraonline.ui.enlatados;
...
public class EnlatadosFragment   extends Fragment {
    ...
    private boolean dist_enlatados;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_enlatados, container, false);
    ...
    public void onActivityCreated  (Bundle savedInstanceState) {
        ...
        tl_output = root.findViewById(R.id.tl_enlatados);
            ...
            target = new Target() {
                ...
                public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    if (PreloadImage) {
                        ...
                        if (NummaxPro[k] > 0 && ((arr_CatProd[k].equals("ENLATADOS"))||(arr_CatProd[k].equals("CONSERVAS"))))
                        {
                            FillTableLayout(k);
    ...
    public void FillTagtName (){
        ...
        for (int i = 0; i <numart; i++)
        {
            TagLayout2Name = "ly_ID_Enl_"+ String.valueOf(i);
            TagTextName = "Tv_ID_Enl_" + String.valueOf(i);
