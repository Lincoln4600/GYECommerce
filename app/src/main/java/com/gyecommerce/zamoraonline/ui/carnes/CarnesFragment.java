package com.gyecommerce.zamoraonline.ui.carnes;
...
public class CarnesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_carnes, container, false);
    ...
    public void onActivityCreated  (Bundle savedInstanceState) {
        ...
        tl_output = root.findViewById(R.id.tl_carnes);
            ...
            target = new Target() {
                ...
                public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    if (PreloadImage) {
                        ...
                        if (NummaxPro[k] > 0 && (arr_CatProd[k].equals("MARISCOS") || arr_CatProd[k].equals("POLLOS") || arr_CatProd[k].equals("CARNES")))
                        {
                            FillTableLayout(k);
