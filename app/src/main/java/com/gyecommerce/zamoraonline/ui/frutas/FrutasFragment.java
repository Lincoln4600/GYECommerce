package com.gyecommerce.zamoraonline.ui.frutas;
...
public class FrutasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_frutas, container, false);
    ...
    public void onActivityCreated  (Bundle savedInstanceState) {
        ...
        tl_output = root.findViewById(R.id.tl_frutas);
            ...
            target = new Target() {
                ...
                public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    if (PreloadImage) {
                        ...
                        if (NummaxPro[k] > 0 && (arr_CatProd[k].equals("FRUTAS") || arr_CatProd[k].equals("VERDURAS")))
                        {
                            FillTableLayout(k);
    ...
    public void FillTableLayout (final int k){
        ...
        TableRow.LayoutParams paramLinearLayout2 = new TableRow.LayoutParams(
                ...
                TableRow.LayoutParams.MATCH_PARENT,
                1.0f);
        second_layout.setBackgroundColor(RED);
        second_layout.setLayoutParams(paramLinearLayout2);
        second_layout.setOrientation(LinearLayout.VERTICAL);
