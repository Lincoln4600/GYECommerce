package com.gyecommerce.zamoraonline.ui.contactanos;
...
public class ContactanosFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_contactanos, container, false);
        ...
        TextView txt_whatssap = root.findViewById(R.id.txt_whatssap);
        ...
        TextView txt_mail = root.findViewById(R.id.txt_mail);
        String mailContacto = preferencias.getString("mailContacto", "");
        txt_mail.setText(mailContacto);

        TextView txt_web = root.findViewById(R.id.txt_web);
